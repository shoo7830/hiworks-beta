	...
	<div class="beta-nav">
		...
		<ul class="sub-menu">
			...
			<router-link tag="li" to="/format-approve"><a>네 가지 결재 포맷</a>
				<ul class="menu-branch format" :class="active">
...
<style>
	...
	.sub-menu li.nuxt-link-active .menu-branch.format.format-approve-view li:nth-of-type(1) > a,
	.sub-menu li.nuxt-link-active .menu-branch.format.format-approve-sendview li:nth-of-type(2)  > a , 
	.sub-menu li.nuxt-link-active .menu-branch.format.format-approve-applyview  li:nth-of-type(3) > a,
